...
docker tag fidelissauro/chip:v2 <AWS ID>.dkr.ecr.us-east-1.amazonaws.com/linuxtips-ecs-cluster/chip:latest

docker push <AWS ID>.dkr.ecr.us-east-1.amazonaws.com/linuxtips-ecs-cluster/chip:latest
